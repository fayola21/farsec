...
(defn ambari-experiment-match-3 [resdir target exp-fnc treatment] ; resdir = data1 or data2
  (if (= treatment "tpp")
    (->> [(exp-fnc 
            (str my-home "/resources/"resdir"/"target"/"target"derby-cross-train.csv")
            (str my-home "/resources/"resdir"/derby/derby-farsec-train.csv") 
            (str my-home "/resources/"resdir"/"target"/"target"derby-cross-test.csv")
            (str my-home "/resources/"resdir"/"target"/"target"derby-farsec-test.csv") 
            (str my-home "/resources/"resdir"/"target"/"target"derby-crossid-test.csv")
            (str my-home "/resources/"resdir"/"target"/"target"derby-farsecid-test.csv") 
            (str my-home "/resources/"resdir"/derby/derby-mat-train.csv") 
            random-forest)
          (run-experiment-3b (str my-home "/resources/"resdir"/"target"/"target"derby-cross-train.csv") (str my-home "/resources/"resdir"/"target"/"target"derby-cross-test.csv") (str my-home "/resources/"resdir"/"target"/"target"derby-crossid-test.csv") random-forest)
          (run-experiment-3b (str my-home "/resources/"resdir"/"target"/"target"derby-cross-train.csv") (str my-home "/resources/"resdir"/"target"/"target"derby-cross-test.csv") (str my-home "/resources/"resdir"/"target"/"target"derby-crossid-test.csv") multilayer-perceptron)
          (exp-fnc 
            (str my-home "/resources/"resdir"/"target"/"target"derby-cross-train.csv")
            (str my-home "/resources/"resdir"/derby/derby-farsec-train.csv") 
            (str my-home "/resources/"resdir"/"target"/"target"derby-cross-test.csv")
            ...
            (str my-home "/resources/"resdir"/derby/derby-mat-train.csv") 
            multilayer-perceptron)
          (run-experiment-3a (str my-home "/resources/"resdir"/"target"/"target"-matid-test.csv"))]
         (transpose)
         (matrix))
    (->> [(exp-fnc 
            (str my-home "/resources/"resdir"/"target"/"target"-mat-train.csv")
            (str my-home "/resources/"resdir"/"target"/"target"-farsec-train.csv") 
            (str my-home "/resources/"resdir"/"target"/"target"-mat-test.csv")
            (str my-home "/resources/"resdir"/"target"/"target"-farsec-test.csv") 
            (str my-home "/resources/"resdir"/"target"/"target"-matid-test.csv")
            (str my-home "/resources/"resdir"/"target"/"target"-farsecid-test.csv") 
            (str my-home "/resources/"resdir"/"target"/"target"-mat-train.csv") 
            naive-bayes)
          (run-experiment-3b (str my-home "/resources/"resdir"/"target"/"target"-mat-train.csv") (str my-home "/resources/"resdir"/"target"/"target"-mat-test.csv") (str my-home "/resources/"resdir"/"target"/"target"-matid-test.csv") naive-bayes)
          (run-experiment-3b (str my-home "/resources/"resdir"/"target"/"target"-mat-train.csv") (str my-home "/resources/"resdir"/"target"/"target"-mat-test.csv") (str my-home "/resources/"resdir"/"target"/"target"-matid-test.csv") logistic-regression)
          (exp-fnc 
            (str my-home "/resources/"resdir"/"target"/"target"-mat-train.csv")
            (str my-home "/resources/"resdir"/"target"/"target"-farsec-train.csv") 
            (str my-home "/resources/"resdir"/"target"/"target"-mat-test.csv")
...
(defn ambari-experiment-match-3b [resdir target exp-fnc treatment] ; resdir = data1 or data2
  (if (= treatment "tpp")
    (->> [(exp-fnc 
            (str my-home "/"resdir"/"target"derby-cross-train.csv")
            (str my-home "/"resdir"/derby-farsec-train.csv") 
            (str my-home "/"resdir"/"target"derby-cross-test.csv")
            (str my-home "/"resdir"/"target"derby-farsec-test.csv") 
            (str my-home "/"resdir"/"target"derby-crossid-test.csv")
            (str my-home "/"resdir"/"target"derby-farsecid-test.csv") 
            (str my-home "/"resdir"/derby-mat-train.csv") 
            ib-k)
          (run-experiment-3b 
            (str my-home "/"resdir"/"target"derby-cross-train.csv") 
            (str my-home "/"resdir"/"target"derby-cross-test.csv") 
          ...
          (exp-fnc 
            ...
            (str my-home "/"resdir"/derby-mat-train.csv") 
            multilayer-perceptron)
          (run-experiment-3a (str my-home "/"resdir"/"target"-matid-test.csv"))]
         (transpose)
         (matrix))
    (->> [(exp-fnc 
            (str my-home "/"resdir"/"target"-mat-train.csv")
            (str my-home "/"resdir"/"target"-farsec-train.csv") 
            (str my-home "/"resdir"/"target"-mat-test.csv")
            (str my-home "/"resdir"/"target"-farsec-test.csv") 
            (str my-home "/"resdir"/"target"-matid-test.csv")
            (str my-home "/"resdir"/"target"-farsecid-test.csv") 
            (str my-home "/"resdir"/"target"-mat-train.csv") 
            multilayer-perceptron)
          (run-experiment-3b 
            (str my-home "/"resdir"/"target"-mat-train.csv") 
